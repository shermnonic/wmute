...
public:
	...
	// Return latest update position
	XnPoint3D GetLastPosition() const { return m_lastUpdatePos; }

	xn::GestureGenerator& GetGestureGenerator() { return m_GestureGenerator; }
	xn::HandsGenerator&	GetHandGenerator() { return m_HandsGenerator; }

	const xn::GestureGenerator& GetGestureGenerator() const { return m_GestureGenerator; }
	const xn::HandsGenerator&	GetHandGenerator() const { return m_HandsGenerator; }
